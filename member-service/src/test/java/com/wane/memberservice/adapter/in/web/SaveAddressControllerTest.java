...
import com.wane.memberservice.adapter.in.web.external.SaveAddressController;
...
class SaveAddressControllerTest {
	...
	void saveAddress() throws Exception {
	    //given
		SaveAddressRequest request = new SaveAddressRequest("재완집", "수취자", "12345", "도로명 주소", "상세 주소", "01012341234", true);
