...
class CreateOrderCommandTest {
	...
	void createOrderCommandMemberIdNotEmpty() {
		...
		CreateOrderRequest request = new CreateOrderRequest(null, 1L, 100, true,1000, "card", List.of(productItemRequest));

		//when //then
		assertThatThrownBy(() -> CreateOrderCommand.of(request))
	...
	void createOrderCommandAddressIdNotEmpty() {
		//given
		ProductItemRequest productItemRequest = new ProductItemRequest(1L, 2);
		CreateOrderRequest request = new CreateOrderRequest(1L, null, 100, true, 1000, "card", List.of(productItemRequest));
	...
	void createOrderCommandTotalPriceGreaterThanZero() {
		//given
		ProductItemRequest productItemRequest = new ProductItemRequest(1L, 2);
		CreateOrderRequest request = new CreateOrderRequest(1L, 1L, -1, true,1000, "card", List.of(productItemRequest));
	...
	void createOrderCommandUsedPointGreaterThanZero() {
		//given
		ProductItemRequest productItemRequest = new ProductItemRequest(1L, 2);
		CreateOrderRequest request = new CreateOrderRequest(1L, 1L, 100,true, -1, "card", List.of(productItemRequest));
	...
	void createOrderCommandCorrectMatchesPaymentType() {
		//given
		ProductItemRequest productItemRequest = new ProductItemRequest(1L, 2);
		CreateOrderRequest request = new CreateOrderRequest(1L, 1L, 100, true,-1, "wrong", List.of(productItemRequest));
	...
	void createOrderCommandProductItemCommandNotEmpty() {
		//given
		CreateOrderRequest request = new CreateOrderRequest(1L, 1L, 100, true,100, "card", List.of());
